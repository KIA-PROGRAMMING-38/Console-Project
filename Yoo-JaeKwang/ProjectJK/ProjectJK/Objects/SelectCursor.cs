        ...
        public static void Render(SelectCursor selectCursor, Player player)
        {
            if (false == player.CanMove)
            {
                if (true == player.IsOnBattle)
                {
                    ...
                    Game.ObjRender(Game.BattleCursor_X + 2, Game.BattleCursor_Y, "Attack", ConsoleColor.Black);
                    Game.ObjRender(Game.BattleCursor_X + 2, Game.BattleCursor_Y + 1, "Escape", ConsoleColor.Black);
                }
                ...
                else
                {
                    Game.ObjRender(selectCursor.X, selectCursor.PastY, ">", ConsoleColor.White);
                    Game.ObjRender(selectCursor.X, selectCursor.Y, ">", ConsoleColor.Black);
                    Game.ObjRender(Game.DialogCursor_X + 2, Game.DialogCursor_Y, "Yes", ConsoleColor.Black);
                    Game.ObjRender(Game.DialogCursor_X + 2, Game.DialogCursor_Y + 1, "No", ConsoleColor.Black);
                }
            }
            else
            {
                Game.ObjRender(Game.DialogCursor_X, Game.DialogCursor_Y, ">", ConsoleColor.White);
                Game.ObjRender(Game.DialogCursor_X, Game.DialogCursor_Y + 1, ">", ConsoleColor.White);
                Game.ObjRender(Game.BattleCursor_X, Game.BattleCursor_Y, ">", ConsoleColor.White);
                Game.ObjRender(Game.BattleCursor_X, Game.BattleCursor_Y + 1, ">", ConsoleColor.White);
                Game.ObjRender(Game.DialogCursor_X + 2, Game.DialogCursor_Y, "Yes", ConsoleColor.White);
                Game.ObjRender(Game.DialogCursor_X + 2, Game.DialogCursor_Y + 1, "No", ConsoleColor.White);
                Game.ObjRender(Game.BattleCursor_X + 2, Game.BattleCursor_Y, "Attack", ConsoleColor.White);
                Game.ObjRender(Game.BattleCursor_X + 2, Game.BattleCursor_Y + 1, "Escape", ConsoleColor.White);
